            ...
            <div className="flex flex-1 flex-col w-full gap-5 pt-5 lg:pt-0 justify-center lg:justify-center lg:items-center lg:px-40 lg:text-center lg:pb-14">
                ...
                <form action="submit" className="flex flex-col gap-4 lg:w-8/12 lg:text-left">
                    <div className="flex flex-col gap-2 lg:gap-1"> 
                        ...
                        <input className="placeholder:dark:text-gray placeholder:text-gray placeholder:text-xs placeholder:font-bold rounded-sm text-black dark:bg-white dark:bg-opacity-20 bg-white dark:text-white placeholder:transition placeholder:duration-500 form-input" type="text" name="FullName" id="fullname" placeholder="Your Full Name" /> 
                    </div>
                    ...
                    <div className="flex flex-col gap-5 lg:gap-1"> 
                        ...
                        <textarea placeholder="About What do you want to Talk?" name="Messages" id="Messages" cols="" rows="3" className="placeholder:dark:text-gray placeholder:text-gray placeholder:text-xs placeholder:font-bold rounded-sm text-black dark:bg-white dark:bg-opacity-20 bg-white dark:text-white placeholder:transition placeholder:duration-500 form-input"></textarea>
                    </div>
